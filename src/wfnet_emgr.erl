...
%%% @doc
%%%
%%% Workflow event manager. This allows clients to receive progress
%%% event notifications from the wfnet server.
%%%
%%% The currently recognized events are: `wf_loaded', `wf_running' and
%%% `wf_completed'.
%%%
%%% @end
